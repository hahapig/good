...
public class RSACryptography {
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println(""+Base64.getUrlEncoder().encodeToString(encryptedBytes));
    System.out.println(Base64Utils.encodeToUrlSafeString(encryptedBytes));
    encryptedBytes = Base64.getUrlDecoder().decode(Base64.getUrlEncoder().encodeToString(encryptedBytes));
    //私钥解密
